...
import { registerRouletteGame } from './backend/games/roulette/game.ts';
import { registerTeenPattiGame } from './backend/games/teen-patti/game.ts';
import { registerAviatorGame } from './backend/games/aviator/game.ts';
import { registerDiceGame } from './backend/games/dice/game.ts';
import { registerDragonTigerGame } from './backend/games/dragon-tiger/game.ts';
import { registerAndarBaharGame } from './backend/games/andar-bahar/game.ts';
