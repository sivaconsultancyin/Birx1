...
CREATE POLICY audit_logs_no_client_access ON public.audit_logs FOR ALL TO anon, authenticated USING (false) WITH CHECK (false);
REVOKE ALL ON TABLE public.audit_logs FROM PUBLIC, anon, authenticated;
CREATE OR REPLACE FUNCTION public.write_audit_log(p_user_id TEXT,p_action TEXT,p_method TEXT,p_path TEXT,p_status_code INTEGER,p_request_id TEXT DEFAULT NULL,p_ip_hash TEXT DEFAULT NULL,p_metadata JSONB DEFAULT '{}'::jsonb)
